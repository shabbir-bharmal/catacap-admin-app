...
router.get("/:id", async (req: Request, res: Response) => {
  try {
    ...
    const campaign: any = {
      ...
      contactInfoAddress2: c.contact_info_address2,
  ...
  try {
    ...
    await pool.query(
      `UPDATE campaigns SET
        ...
        contact_info_address2 = $13, contact_info_email_address = $14,
      ...
      [
        ...
        campaign.contactInfoAddress2 ?? existing.contact_info_address2,
  ...
  try {
    ...
    const cloneResult = await pool.query(
      `INSERT INTO campaigns (
        name, description, themes, approved_by, sdgs, investment_types, terms,
        minimum_investment, website, network_description, contact_info_full_name,
        contact_info_address, contact_info_address2, contact_info_phone_number,
