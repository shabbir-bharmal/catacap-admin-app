...
namespace Invest.Controllers.Admin
{
    ...
    public class FinancesController : Controller
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            var groups = await _repositoryContext.Groups
            ...
            var allLeaderIds = groups
                                ...
                                .SelectMany(g => JsonSerializer.Deserialize<List<GroupLeadersDto>>(g.Leaders!)!
                                    .Select(l => l.UserId))
                                .Where(id => id != null)
                                .ToList();
            ...
            var groupStats = new
            {
                Leaders = allLeaderIds.Count,
                Corporate = groups.Count(g => g.IsCorporateGroup),
        ...
        {
            var result = await Get() as OkObjectResult;
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                AddRow("Investment groups (group leaders)", $"{financesDto.Groups.Investments} ({financesDto.Groups.Leaders})");
